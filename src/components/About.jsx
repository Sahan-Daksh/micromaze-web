...
const About = () => {
  return (
    ...
    >
      <motion.div
        className="relative z-10 h-full flex flex-col justify-center px-4 sm:px-6 md:px-8 lg:px-10 items-end"
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1 }}
        style={{ willChange: 'opacity, transform' }}
      >
        <div className="flex flex-col items-center w-full max-w-4xl p-6 sm:p-8 md:p-10 lg:p-12 bg-transparent rounded-lg">
          <motion.p
          ...
          <motion.div
            className="flex flex-col items-center bg-transparent w-full max-w-3xl rounded-lg p-6 sm:p-8 md:p-10 lg:p-12 shadow-lg backdrop-blur-md"
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 1, delay: 1 }}
            style={{ willChange: 'opacity, transform' }}
          >
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-purple-600 text-center">
